(function defineMockData(global) {
  ...
  const suppliers = [
    ...
    ["S019", "宁波办公服务有限公司", "ORG-EAST", "U201", ["CAT-OFFICE", "CAT-PACKAGING"], "注册", "有价值", "注册中", "供应商申请", false, "2027-08-12", { "CAT-OFFICE": "双方低利益", "CAT-PACKAGING": "双方低利益" }],
    ...
    ["S025", "北方云科设备有限公司", "ORG-NORTH", "U209", ["CAT-IT"], "注册", "有价值", "注册中", "供应商申请", false, "2027-01-18", { "CAT-IT": "供应商有利" }]
  ].map((row) => ({
    id: row[0],
    name: row[1],
    orgId: row[2],
  ...
  const categoryCertifications = [
    ...
    ["CC024", "S019", "CAT-OFFICE", "认证中", "采购审核", "2026-05-12", "", "U201"],
    ...
    ["CC031", "S025", "CAT-IT", "认证中", "资料复核", "2026-01-18", "", "U209"],
